...
export const fiendkin: AncestryDefinition = {
  ...
  nameConfig: {
    male: {
      syllables: {
        prefixes: ['ash', 'bane', 'drak', 'grim', 'kael', 'mal', 'rath', 'scar', 'thorn', 'vex', 'zar', 'neth', 'vel', 'mor'],
    ...
    female: {
      syllables: {
        prefixes: ['ash', 'bel', 'dara', 'lil', 'nyx', 'raven', 'sera', 'vera', 'zara', 'mira', 'kira', 'vex', 'neth'],
    ...
    surnames: {
      syllables: {
        prefixes: ['ash', 'blood', 'dark', 'fire', 'hell', 'night', 'shadow', 'soul', 'thorn', 'void', 'flame', 'bane'],
        middle: ['heart', 'soul', 'mind', 'eye', 'hand', 'wing'],
        suffixes: ['born', 'bane', 'heart', 'soul', 'mind', 'eye', 'hand', 'wing', 'thorn', 'fire', 'ash', 'void']
      },
      patterns: ['P', 'PS', 'PM'],
      constraints: {
        minLength: 4,
