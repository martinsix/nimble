...
export const minotaur: AncestryDefinition = {
  ...
  nameConfig: {
    male: {
      syllables: {
        prefixes: ['bull', 'horn', 'thund', 'storm', 'rage', 'fury', 'wild', 'beast', 'strong', 'might', 'power', 'force'],
        middle: ['horn', 'hoof', 'charge', 'rush', 'strike', 'crush'],
        suffixes: ['horn', 'hoof', 'charge', 'rush', 'strike', 'crusher', 'born', 'blood', 'heart', 'soul']
      },
      patterns: ['P', 'PS', 'PM'],
      constraints: {
        minLength: 4,
    ...
    female: {
      syllables: {
        prefixes: ['wild', 'free', 'swift', 'grace', 'moon', 'star', 'wind', 'storm', 'earth', 'nature', 'spirit'],
        middle: ['heart', 'soul', 'song', 'dance', 'run', 'leap'],
        suffixes: ['heart', 'soul', 'song', 'dance', 'runner', 'leaper', 'born', 'maiden', 'horn', 'hoof']
      },
      patterns: ['P', 'PS', 'PM'],
      constraints: {
        minLength: 4,
