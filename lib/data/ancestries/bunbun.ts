...
export const bunbun: AncestryDefinition = {
  ...
  nameConfig: {
    unisex: {
      syllables: {
        prefixes: ['hop', 'skip', 'bounce', 'fluffy', 'cotton', 'whiskers', 'bunny', 'carrot', 'clover', 'daisy', 'pepper', 'ginger', 'honey', 'maple', 'willow'],
        middle: ['tail', 'paw', 'ear', 'nose', 'hop', 'bound', 'jump', 'spring', 'leap', 'dash'],
        suffixes: ['paw', 'tail', 'ear', 'nose', 'hop', 'bound', 'foot', 'whiskers', 'cotton', 'fluff', 'spring', 'dash', 'bounce']
      },
      patterns: ['P', 'PS', 'PM'],
      constraints: {
        minLength: 3,
