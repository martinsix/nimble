...
export const shepherdLuminaryMercy: SubclassDefinition = {
  ...
  description: 'A shepherd who embraces the healing light, dedicated to preserving life and bringing comfort to the suffering.',
  features: [
    {
      id: 'merciful-healing',
      level: 3,
    ...
    },
    {
      ...
      description: 'Harmless and lovely creatures such as butterflies and humming birds are attracted to your presence and often follow you. Flowers bloom more vibrantly in your presence.',
      category: 'social'
    },
    {
      id: 'conduit-of-light',
      ...
      ability: {
        id: 'conduit-of-light',
        name: 'Conduit of Light',
        description: 'When you heal HP, expend 1 Searing Light to heal/damage another target for the same amount.',
        type: 'action',
        frequency: 'at_will'
      }
    },
    {
      ...
      ability: {
        id: 'powerful-healer',
        name: 'Powerful Healer',
        description: 'Instead of rolling healing dice, heal the max amount or give that many temp HP.',
        type: 'action',
