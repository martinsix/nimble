    ...
    effects: [
      {
        ...
        ability: {
          id: 'bring-the-pain',
          name: 'Bring the Pain',
          description: 'Turn any melee attack into a crit. When crit, take half damage and reflect it to attacker. Suffer 1 Wound to double reflected damage.',
          type: 'action',
          frequency: 'at_will'
        }
      }
...
export const wayOfPain: SubclassDefinition = {
  id: 'way-of-pain',
  name: 'Way of Pain',
  description: 'Zephyrs who embrace pain as a teacher, turning damage taken into power and reflecting suffering back upon their enemies.',
